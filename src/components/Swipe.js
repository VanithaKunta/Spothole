   ...
   return (
     ...
     <Swiper style={styles.wrapper} showsButtons={true} index={1} loop={false}>
       ...
       <View style={styles.slide3}>
         <Image source={require('./bg5.png')} style={styles.backgroundImage}/>
       </View>

       <View style={styles.slide2}>
       <Image source={require('./bg6.jpg')} style={styles.backgroundImage}/>
       <TouchableOpacity style={styles.button} onPress={() => Actions.Connection()}>    
